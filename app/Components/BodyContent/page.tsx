...
export const BodyContent=()=>{
    ...
    return (
       ...
       quality={100}
        ...
        height={100}
      />
                {/* <Image alt="Mobile_pic" width={0} height={100}  className="text-center rounded-xl items-center"  src={mobile_pic}></Image> */}
        </div>
      <IQCard EQ_CONTENT={ EQ_CONTENT} />
        ...
        <div className='flex flex-row my-8 overflow-x-auto  gap-4' style={{width: '100%', scrollbarWidth: 'none', scrollbarColor: 'white', msOverflowStyle: 'none'}}>
  {
      cardsData.map((data,index)=>(
        <div className="flex" key={index} style={{minWidth: '300px'}}>
          <Cards  heading={data.heading} 
            title={data.title}
