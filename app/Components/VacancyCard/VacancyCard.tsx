          ...
          return (
            <>
              ...
              >
                ...
                <ol className="">
                  <li className="mb-3 text-sm ">{data.titleOne}</li>
                  <li className="mb-3 text-sm">{data.titleTwo} </li>
                  <li className="mb-3 text-sm">{data.titleThree}</li>
                </ol>
                {visibleButtonId === data.id && (
                  <button
